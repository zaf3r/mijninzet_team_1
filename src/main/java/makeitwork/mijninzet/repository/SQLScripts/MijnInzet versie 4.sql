...
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (1,1);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (1,2);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (1,3);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (2,1);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (2,2);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (2,3);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (3,1);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (3,2);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (3,3);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (4,1);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (4,2);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (4,3);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (5,1);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (5,2);
INSERT INTO `mijninzet`.`dagdeel` (`werkdag`, `dagdeel`) VALUES (5,3);
